Controls:
1 to display Serpinsky Triangle, 2 to display the Square Diamond, 3 to display the Koch Snowflake
Use the left and right arrow keys to change the amount of iterations of each fractal
